...
python tnn_parte3_analizador.py  ./NLLLOSS/tnn_parte3_N8_l2_result.csv ./Plots/2-Capa-8-Neu
...
python tnn_parte3_analizador.py  ./NLLLOSS/tnn_parte3_N16_l1_result.csv ./Plots/1-Capa-16-Neu
...
python tnn_parte3_analizador.py  ./NLLLOSS/tnn_parte3_N16_l2_result.csv ./Plots/2-Capa-16-Neu
